...
function generateStars(numStars: number, xMax: number, yMax: number) {
  let stars: ApparentStar[] = [];
  for (let i = 0; i < numStars; ++i) {
    const star: ApparentStar = {
...
function drawStars(stars: ApparentStar[]) {
